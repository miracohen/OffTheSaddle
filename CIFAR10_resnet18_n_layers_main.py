...
import os 
import datetime
from CIFAR10_resnet18_n_layers import Block, ResNet_18, CustomTensorDataset, CIFAR10_RESNET18
...
def main():
    ...
    CIFAR10_RESNET18.set_criterion_optimizer_scheduler(OPTIMIZER_TYPE, criterion, optimizer, lr_scheduler)
