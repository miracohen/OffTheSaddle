...
class CIFAR10_RESNET18():
    ...
    def set_criterion_optimizer_scheduler(cls, optimizer_type, criterion, optimizer, lr_scheduler):
        ...
        cls.path_save_model = r"./runs/CIFAR10_RESNET18/" + cls.optimizer_type + "/2_lin_layers_P=30_STD_B_STATS_BATCH_SZ=" + str(BATCH_SIZE) + "LOG_" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
