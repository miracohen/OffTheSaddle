...
class CIFAR10_ALEXNET():
    ...
    def init_model(cls,image_channels, num_classes):
        cls.model = AlexNet(image_channels, num_classes)
        cls.model.to(DEVICE)
    ...
    def set_criterion_optimizer_scheduler(cls, optimizer_type, criterion, optimizer, lr_scheduler):
        ...
        cls.path_save_model = r"./runs/CIFAR10_AlexNet/" + cls.optimizer_type + "/AlexNet_BATCH_SZ=" + str(BATCH_SIZE) + "LOG_" + datetime.datetime.now().strftime("%Y%m%d-%H%M%S")
        ...
        for epoch in range(num_epochs):
            ...
            for phase in ['train', 'val']: # Each epoch has a training and validation phase
                ...
                for inputs, labels in cls.dataloaders[phase]: # Iterate over data
                    inputs = transforms.functional.resize(inputs, (227, 227))
